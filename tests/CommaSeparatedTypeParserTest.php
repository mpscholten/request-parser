...
class CommaSeparatedTypeParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $expected = [1, 2, 3, 4];
        $result = (new CommaSeparatedIntParser($this->createExceptionFactory(),  new MessageFactory(), 'intArr', '1,2,3,4'))->required();
    ...
    public function testCsvWithFloat()
    {
        ...
        $result = (new CommaSeparatedFloatParser($this->createExceptionFactory(),  new MessageFactory(), 'intArr', '1.1,2.99,3.4,4.13'))->required();
        $this->assertEquals($expected, $result);
    }
    ...
    public function testCsvWithString()
    {
        ...
        $result = (new CommaSeparatedStringParser($this->createExceptionFactory(),  new MessageFactory(), 'intArr', 'apples,oranges,tomatoes'))->required();
        $this->assertEquals($expected, $result);
    }
    ...
    public function testCsvWithDateTime()
    {
        ...
        $result = (new CommaSeparatedDateTimeParser($this->createExceptionFactory(),  new MessageFactory(), 'intArr', '2016-01-01,2016-01-02,2016-01-03'))->required();
        $this->assertEquals($expected, $result);
    }
    ...
    public function testCsvWithJson()
    {
        ...
        $result = (new CommaSeparatedJsonParser($this->createExceptionFactory(),  new MessageFactory(), 'intArr', $value))->required();
        $this->assertEquals($expected, $result);
    }
    ...
    public function testCsvWithBoolean()
    {
        ...
        $result = (new CommaSeparatedBooleanParser($this->createExceptionFactory(),  new MessageFactory(), 'boolArr', 'false,true,true'))->required();
        $this->assertEquals($expected, $result);
    }
    ...
    public function testCsvWithYesNoBoolean()
    {
        ...
        $result = (new CommaSeparatedYesNoBooleanParser($this->createExceptionFactory(),  new MessageFactory(), 'yesNoBoolArr', 'Y,N,Y'))->required();
        $this->assertEquals($expected, $result);
    }
}
